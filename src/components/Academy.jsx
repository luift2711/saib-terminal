...
import { ChevronRight, Database, Check, ChevronLeft, Cpu, Bitcoin, DollarSign } from 'lucide-react';
...
const Academy = () => {
  ...
  return (
    ...
    <div className="h-full overflow-hidden bg-[#faf9f6] dark:bg-[#0e1117] text-[#0f1117] dark:text-[#e8eaf0] font-sans selection:bg-[#b45309]/30 dark:selection:bg-[#00d084]/30 transition-colors duration-500">
      ...
      <div className="fixed inset-0 z-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#b45309]/15 via-[#faf9f6] to-[#faf9f6] dark:from-[#00d084]/10 dark:via-[#0e1117] dark:to-[#0e1117] pointer-events-none"></div>
      ...
      <div className="h-full flex relative z-10">
        ...
        <aside className="w-72 shrink-0 h-full flex flex-col border-r border-[rgba(15,17,23,0.08)] dark:border-[rgba(255,255,255,0.06)] bg-[#faf9f6]/80 dark:bg-[#0e1117]/80 backdrop-blur-sm">
          ...
          <div className="p-5 border-b border-[rgba(15,17,23,0.08)] dark:border-[rgba(255,255,255,0.06)]">
            <motion.div
              ...
              className="bg-[#fff]/60 dark:bg-black/40 backdrop-blur-md rounded-2xl p-5 border border-[#b45309]/40 dark:border-[rgba(255,255,255,0.1)] relative overflow-hidden shadow-sm"
            >
              <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-[#b45309] dark:via-[#00d084] to-transparent"></div>
              <div className="flex justify-between items-center mb-3">
                <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-[#b45309] dark:text-[#00d084] flex items-center gap-2">
              ...
              <div className="h-1 rounded-full bg-[rgba(15,17,23,0.1)] dark:bg-[rgba(255,255,255,0.05)] overflow-hidden relative">
                <motion.div
                  ...
                  className="absolute top-0 left-0 h-full bg-[#b45309] dark:bg-[#00d084] shadow-[0_0_10px_rgba(180,83,9,0.5)] dark:shadow-[0_0_10px_rgba(0,208,132,0.5)]"
                />
              </div>
            </motion.div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto py-4 px-3 space-y-6 custom-scrollbar">
            {chapters.map((chapter, chapterIndex) => (
              ...
              >
                <h3 className="text-[10px] font-mono uppercase tracking-[0.18em] text-[#b45309] dark:text-[#00d084] border-b border-[#b45309]/20 dark:border-[#00d084]/20 pb-2 mb-3 px-2 flex items-center gap-2">
                  <span className="w-1 h-1 bg-[#b45309] dark:bg-[#00d084] rounded-full"></span>
                  {chapter.title}
                </h3>
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-left transition-all duration-200 ${
                          active
                            ? 'bg-[rgba(180,83,9,0.12)] dark:bg-[#00d084]/10 border border-[#b45309]/40 dark:border-[#00d084]/30 text-[#0f1117] dark:text-[#00d084]'
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1.5 shrink-0 ml-2 perspective-1000">
                          {done && <Check size={12} className="text-[#b45309] dark:text-[#00d084] opacity-80" />}
                          {active && (
                            <>
                              <DollarSign size={14} className="hidden dark:block text-[#00d084] animate-deep-pulse" />
                              <div className="block dark:hidden coin-animate shrink-0">
                                <div className="w-[16px] h-[16px] bg-gradient-to-br from-[#f8a139] to-[#d97706] rounded-full flex items-center justify-center border border-[#b45309] shadow-sm">
                                  <Bitcoin size={10} className="text-white" strokeWidth={2.5} />
                                </div>
                              </div>
                            </>
                          )}
        ...
        >
          <div className="max-w-4xl mx-auto p-6 md:p-10">
            ...
            >
              {/* Top accent line */}
              <div className="h-[3px] w-full bg-gradient-to-r from-transparent via-[#b45309] dark:via-[#00d084] to-transparent" />
                ...
                <button
                  ...
                  className={`w-full py-3.5 rounded-xl font-mono text-[12px] tracking-[0.12em] transition-all duration-300 uppercase flex items-center justify-center gap-2 ${
                    completedLessons.has(selectedLesson.id)
                      ? 'bg-transparent border border-[#b45309] dark:border-[#00d084]/50 text-[#b45309] dark:text-[#00d084]'
      ...
      <style>{`
        ...
        .custom-scrollbar:hover::-webkit-scrollbar-thumb { background: rgba(180,83,9,0.4); }
