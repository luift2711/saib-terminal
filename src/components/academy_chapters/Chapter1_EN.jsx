          ...
          {q.candles.map((candle, index) => (
            <div key={index} className="flex flex-col items-center">
              ...
              {index === q.candles.length - 1 && (
                <div className="text-[11px] text-[#FCD535] mt-2 font-bold">This candle</div>
              )}
            </div>
          ))}
        </div>
      ...
      <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
          <div className="border border-gray-200 dark:border-[#2B3139] bg-white dark:bg-transparent p-5 rounded-2xl shadow-sm">
            ...
            <div className="text-[14px] text-gray-500 dark:text-[#64748B] mt-2">Usually less volatile.</div>
          </div>
          <div className="border border-yellow-200 dark:border-[#FCD535]/30 bg-yellow-50 dark:bg-[#FCD535]/5 p-5 rounded-2xl shadow-sm">
            ...
            <div className="text-[14px] text-yellow-700 dark:text-[#FCD535] mt-2">Liquidity increases, EUR/GBP are very active.</div>
          </div>
          <div className="border-2 border-yellow-400 dark:border-[#FCD535]/50 bg-yellow-100 dark:bg-[#FCD535]/10 p-5 rounded-2xl shadow-sm">
            ...
            <div className="text-[14px] text-yellow-800 dark:text-[#FCD535] mt-2">USD dominates, US news usually causes massive volatility.</div>
          </div>
          <div className="border border-blue-200 dark:border-[#378ADD]/30 bg-blue-50 dark:bg-[#378ADD]/5 p-5 rounded-2xl shadow-sm">
            ...
            <div className="text-[14px] text-blue-700 dark:text-[#378ADD] mt-2">Usually the highest liquidity zone of the day.</div>
          </div>
        </div>
    ...
    content: (
      <>
        ...
        <div className="bg-[#0d1117] rounded-2xl p-6 my-8 overflow-x-auto border border-gray-800">
          <div className="text-[11px] text-gray-400 font-mono uppercase tracking-widest mb-4">// Anatomy of a candlestick — Click/hover to explore</div>
    ...
    content: (
      <>
        ...
        <div className="my-8">
          ...
          <p className="text-[13px] text-[#636878] dark:text-[#5a6275] mt-3 font-mono">⭐ D1 and H4 are the two core timeframes in our system.</p>
        </div>
