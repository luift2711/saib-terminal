...
const NameRegistration = () => {
  ...
  return (
    <FadeUp className="my-16 text-center max-w-xl mx-auto px-4 bg-white dark:bg-[#181A20] border border-gray-200 dark:border-[#2B3139] p-8 rounded-3xl shadow-sm dark:shadow-none">
      <div className="text-[12.5px] font-mono tracking-[0.2em] uppercase text-[#D4AF37] mb-4">Enter your name</div>
      <h3 className="text-2xl font-serif font-bold text-black dark:text-white mb-4">Register to start your journey</h3>
      <p className="text-[16.5px] text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
        Your name will be saved and used for the Trader's Oath and Graduation Certificate at the end of the course (Chapter 6).
      </p>
