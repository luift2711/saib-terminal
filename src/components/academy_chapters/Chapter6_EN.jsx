    ...
    <div className="border border-gray-200 dark:border-[#2B3139] rounded-3xl overflow-hidden my-8 bg-gray-50 dark:bg-[#0B0E11] shadow-md dark:shadow-xl">
      ...
      <div className="p-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
          ...
          <div className="flex items-end"><button onClick={addEntry} className="w-full py-2 rounded-xl font-black text-sm bg-yellow-500 dark:bg-[#00d084] hover:bg-yellow-400 dark:hover:bg-[#00e691] text-black transition-all">+ Add</button></div>
        </div>
        ...
        <button onClick={clear} className="mt-4 px-5 py-2 border border-gray-300 dark:border-[#2B3139] text-gray-600 dark:text-[#848E9C] rounded-xl text-[15.5px] font-bold hover:bg-gray-100 dark:hover:bg-[#181A20] transition-colors">🗑 Clear all</button>
      </div>
    </div>
  );
};
      ...
      <div className="relative z-10">
        ...
        {!sworn ? (
          <>
            ...
            <button onClick={takeOath} className="px-8 py-3 bg-gradient-to-br from-orange-500 to-yellow-500 text-black font-black text-[17.5px] rounded-xl hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(245,166,35,0.3)] transition-all">✦ I Take the Oath ✦</button>
          </>
        ) : (
